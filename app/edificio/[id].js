...
import PlanoIngenieria from '../../src/components/Planos/PlanoIngenieria';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.svgContainer}>
        ...
        <Text style={styles.svgPlaceholderText}>
          <View style={styles.svgContainer}>
            {id === 'fac_ingenieria' ? <PlanoIngenieria /> : <Text>Plano no disponible</Text>}
          </View>
...
const styles = StyleSheet.create({
  ...
  svgContainer: { height: '45%', backgroundColor: '#F3F4F6', justifyContent: 'center', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#E5E7EB' },
  ...
  statBox: { flex: 1, backgroundColor: '#FFFFFF', marginHorizontal: 4, paddingVertical: 16, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: '#F3F4F6', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05 },
  statNumber: { fontSize: 24, fontWeight: '900' },
  statLabel: { fontSize: 12, color: '#6B7280', marginTop: 4, fontWeight: '500' },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#111827', marginBottom: 16 },
  aulaCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: '#FFFFFF', borderRadius: 12, marginBottom: 12, borderWidth: 1, borderColor: '#F3F4F6', elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05 },
  aulaInfo: { flex: 1 },
